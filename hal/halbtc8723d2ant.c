...
static void halbtc8723d2ant_limited_rx(struct btc_coexist *btcoexist,
...
static void halbtc8723d2ant_adjust_wl_tx_power(struct btc_coexist *btcoexist,
			      boolean force_exec, u8 fw_dac_swing_lvl)
{
...
static void halbtc8723d2ant_adjust_bt_tx_power(struct btc_coexist *btcoexist,
				boolean force_exec, u8 dec_bt_pwr_lvl)
{
	u8			h2c_parameter[1] = {0};
...
static void halbtc8723d2ant_set_bt_auto_report(struct btc_coexist *btcoexist,
...
static void halbtc8723d2ant_bt_auto_report(struct btc_coexist *btcoexist,
...
static boolean halbtc8723d2ant_is_wifibt_status_changed(struct btc_coexist
		*btcoexist)
{
...
static void halbtc8723d2ant_ltecoex_set_break_table(struct btc_coexist *btcoexist,
...
static void halbtc8723d2ant_set_wltoggle_coex_table(struct btc_coexist *btcoexist,
...
static boolean halbtc8723d2ant_psd_sweep_point(struct btc_coexist *btcoexist,
...
static boolean halbtc8723d2ant_psd_antenna_detection(struct btc_coexist
		*btcoexist)
{
	u32	i = 0;
...
static boolean halbtc8723d2ant_psd_antenna_detection_check(struct btc_coexist
		*btcoexist)
{
