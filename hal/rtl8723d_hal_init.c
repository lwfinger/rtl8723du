...
static int ReservedPage_Compare(struct adapter * Adapter, struct rt_mp_firmware *pFirmware, u32 BTPatchSize)
{
...
*/
int FirmwareDownloadBT(struct adapter * adapt, struct rt_mp_firmware *pFirmware)
{
	int rtStatus;
	u8 *pBTFirmwareBuf;
	u32 BTFirmwareLen;
