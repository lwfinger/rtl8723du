...
/* Get element */
#define GET_CVID_IC_TYPE(version)			((((HAL_VERSION)version).ICType))
#define GET_CVID_CHIP_TYPE(version)			((((HAL_VERSION)version).ChipType))
#define GET_CVID_RF_TYPE(version)			((((HAL_VERSION)version).RFType))
#define GET_CVID_MANUFACTUER(version)		((((HAL_VERSION)version).VendorType))
#define GET_CVID_CUT_VERSION(version)		((((HAL_VERSION)version).CUTVersion))
